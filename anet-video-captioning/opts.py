...
def parse_opt():
    ...
    parser.add_argument('--t_attn_size', type=int, default=480, help='number of frames sampled for temporal attention')
...
def add_cyclical_args(parser):
    ...
    parser.add_argument('--finetune_cnn', default=0, type=int, help='finetune CNN')
    parser.add_argument('--second_drop_prob', type=float, default=0.5,
                        help='strength of dropout in the ROI feature extractor')

    # ROIs
    parser.add_argument('--vis_encoding_size', type=int, default=2048, help='visual words embedding size')

    # Model
    parser.add_argument('--softattn_type', default='dot-product', type=str,  help='additive | dot-product')
    parser.add_argument('--softmax_temp', default=1, type=float, help='the temperature for softmax')
    ...
    parser.add_argument('--localizer_softmax_temp', type=float, default=1, help='the softmax temperature for localizer')
    ...
    parser.add_argument('--resume', default=False, type=bool, help='two options for resuming the model: latest | best')
    parser.add_argument('--tensorboard', type=int, default=1, help='Use Tensorboard')
    parser.add_argument('--tb_log_dir', default='tb_logs', type=str, help='path to Tensorboard log file')
    ...
    parser.add_argument('--resume_embed', default=0, type=int, help='if 1, we will also resume the embedding layer')
    parser.add_argument('--resume_logit', default=0, type=int, help='if 1, we will also resume the logit layer')
    parser.add_argument('--resume_roi_extractor', default=0, type=int, help='if 1, we will also resume the ROI feature extractor')
    parser.add_argument('--checkpoint_dir', type=str, default='save/', help='directory to store checkpointed models')
